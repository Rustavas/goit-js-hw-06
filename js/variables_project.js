const headingAll = document.getElementById('all');
const headingOne = document.getElementById('1');
const headingTwo = document.getElementById('2');
const headingThree = document.getElementById('3');
const headingFour = document.getElementById('4');
